      ...
      <section className='flex-1 flex flex-col gap-6 overflow-hidden px-5'>
        {
          !inGame && (
            <>
              ...
              <section>
                <Button asChild>
                  <a href={data?.meta.url} target='_blank' rel="noreferrer">Open Build <ExternalLink
        ...
        <div className={`flex flex-col gap-4 ${inGame ? 'overflow-hidden' : 'overflow-y-auto'}`} ref={listRef}>
          {
